...
<html lang="en">
	<head>
		...
		<title>Youtube Downloader :: 404</title>
	...
	<body>
		<div class="jumbotron jumbotron-fullheight jumbo-vertical-center text-light text-center bg-dark mb-0 radius-0">
			<div class="container">
				<h1 class="display-2 text-light text-uppercase">Error 404</h1>
				<span class="lead lead-lg">Not Found</span>
					<div class="mt-4">
						<a href="/" class="btn btn-danger btn-lg m-2 btn-wide">
							<span>Home</span>
						</a>
					</div>
			</div>
